...
import { CheckCircle2, ArrowRight, Instagram, MessageCircle } from 'lucide-react';
...
export default function PaymentSuccess() {
    ...
    // PayPal payment details from URL params
    ...
    useEffect(() => {
        const triggerNotification = async () => {
            ...
            const txId = `notified_${method}_${name}_${amount}`;
        ...
        <div className="min-h-[80vh] flex items-center justify-center px-6 py-20 relative overflow-hidden">
            ...
            >
                ...
                <h1 className="text-4xl md:text-5xl font-display font-black mb-4 tracking-tighter">
                    PAYMENT <span className="text-brand-red">SUCCESSFUL</span>
                </h1>

                <p className="text-lg text-white/70 font-light mb-8 leading-relaxed">
                    Welcome to the team{name ? ', ' : ''}<span className="text-white font-bold">{name}</span>!
                    <br />
                    {plan && <>Your <span className="text-white font-bold">{plan}</span> plan is now active.</>}
                </p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="pt-8 flex items-center justify-center gap-6 border-t border-white/10 mt-8">
                        <a href="https://instagram.com/dr_akramikni" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors">
                            <Instagram size={20} />
                        </a>
                        <a href="https://wa.me/213783766209" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors">
