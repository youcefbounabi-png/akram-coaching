                                            ...
                                            {planCurrency === 'DZD' && (
                                                <div className="mt-4">
                                                    <a
                                                        ...
                                                        className="w-full py-4 rounded-2xl bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold text-sm tracking-widest uppercase flex items-center justify-center gap-3 transition-all duration-300 cursor-pointer active:scale-95 shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:shadow-[0_0_30px_rgba(37,211,102,0.5)]"
                                                    >
