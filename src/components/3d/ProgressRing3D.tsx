...
import { Torus, Float, Text, Preload } from '@react-three/drei';
  ...
  return (
    <group ref={groupRef}>
      <Float speed={2} rotationIntensity={0.2} floatIntensity={0.5}>
        {/* Outer Progress Ring */}
        <Torus ref={ring1} args={[2.2, 0.03, 12, 64, Math.PI * 1.5]} rotation={[0, 0, 0]}>
          <meshStandardMaterial color="#ec3642" emissive="#ec3642" emissiveIntensity={2} />
        </Torus>

        {/* Inner Wireframe Ring */}
        <Torus ref={ring2} args={[1.8, 0.05, 12, 64, Math.PI * 2]} rotation={[0, 0, 0]}>
          <meshStandardMaterial color="#ffffff" emissive="#ffffff" emissiveIntensity={0.5} wireframe />
        </Torus>

        {/* Core Abstract Ring */}
        <Torus ref={ring3} args={[1.4, 0.01, 6, 32]} rotation={[0, 0, 0]}>
