...
export const BackgroundBeams = React.memo(
    ({ className }: { className?: string }) => {
        // Stabilize random values using useMemo to prevent jank on re-renders
                ...
                >
                    ...
                    {STATIC_PATHS.map((path, index) => (
                        <motion.path
                            ...
                            strokeWidth="1.8"
                            style={{
                                filter: "drop-shadow(0 0 5px rgba(236, 54, 66, 0.7))",
                    ...
                    <defs>
                        {STATIC_PATHS.map((_, index) => (
                            ...
                            >
                                <stop stopColor="#ec3642" stopOpacity="0"></stop>
                                <stop stopColor="#ec3642"></stop>
                                <stop offset="32.5%" stopColor="#ff4d4d"></stop>
