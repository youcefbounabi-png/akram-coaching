    ...
    const plans: Plan[] = [
        {
            ...
            chargelyUrl: '#',
            features: [tf.dietTailored, tf.trainingVideos, tf.cardioTiming, tf.customGoals, tf.maleFemale],
            popular: false,
        },
        {
            id: 'premium',
            ...
            chargelyUrl: '#',
            features: [tf.monitoring3, tf.healthChecks, tf.onlineFollowup, tf.cardioTiming, tf.supplements, tf.customGoals, tf.dailyFollowup, tf.maleFemale],
            popular: true,
        },
        {
            id: 'elite',
            ...
            chargelyUrl: '#',
            features: [tf.monitoring6, tf.healthChecks, tf.onlineFollowup6, tf.cardioTiming, tf.supplements, tf.customGoals, tf.dailyFollowup, tf.maleFemale],
            popular: false,
        },
    ];
            ...
            <section className="py-12 pb-24">
                <div className="container max-w-3xl mx-auto px-6 text-center">
                    <p className="text-white/50 text-lg font-light">
                        {tp.faqCta}{' '}
                        <Link href={`/${lang}/contact`} className="text-brand-red font-bold hover:underline cursor-pointer">
                            {tp.contactUs}
                        </Link>{' '}
                        {tp.faqSuffix}
                    </p>
