...
// ─── Constants ───────────────────────────────────────────────────────────────
const ADMIN_PASSWORD = process.env.NEXT_PUBLIC_ADMIN_PASSWORD || 'akram2024';
                ...
                <AnimatePresence mode="wait">
                    {activeSection === 'overview' && (
                        <motion.div key="overview" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-8">
                            ...
                            {!isMounted ? (
                                <div className="h-[260px] flex items-center justify-center glass-panel rounded-2xl border border-white/8">
                                            ...
                                            <div className="flex items-center gap-6">
                                                <ResponsiveContainer width="50%" height={200}>
                                                    <PieChart>
                                                        ...
                                                        <ChartTooltip contentStyle={tooltipStyle} formatter={(v: any) => [v]} />
                                                    </PieChart>
                                                </ResponsiveContainer>
