                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div initial={{ opacity: 0, x: isRTL ? 40 : -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9 }}>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                <Link href={`/${lang}/pricing`} className="inline-flex items-center justify-center gap-3 bg-brand-red text-white px-10 py-5 rounded-full font-bold text-lg hover:scale-105 active:scale-95 transition-all duration-300 red-glow-strong group cursor-pointer">
                                    {tc.joinBtn}
                                </Link>
                        ...
                        <motion.div initial={{ opacity: 0, x: isRTL ? -40 : 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9, delay: 0.2 }} className="relative h-auto rounded-[3rem] glass-panel overflow-hidden border-white/10 hidden lg:block group">
                            <img
                                src={promoCoaching.src || promoCoaching as unknown as string}
                ...
                <div className="container max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <motion.div initial={{ opacity: 0, x: isRTL ? -30 : 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }} viewport={{ once: true }} className="glass-panel rounded-[2.5rem] p-10 border-brand-red/20">
                            ...
                            <Link href={`/${lang}/pricing`} className="w-full bg-brand-red text-white py-4 rounded-2xl font-bold uppercase tracking-widest text-center hover:bg-brand-red/90 transition-colors block cursor-pointer red-glow">
                                {t.home.seePricing}
                            </Link>
                        </motion.div>
                    </div>
