        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-24">
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/70 font-light">
              <li><Link href={`/${lang}`} className="hover:text-brand-red transition-colors">{tf.links.home}</Link></li>
              <li><Link href={`/${lang}/transformations`} className="hover:text-brand-red transition-colors">{tf.links.transformations}</Link></li>
              <li><Link href={`/${lang}/pricing`} className="hover:text-brand-red transition-colors">{tf.links.pricing}</Link></li>
              <li><Link href={`/${lang}/about`} className="hover:text-brand-red transition-colors">{tf.links.about}</Link></li>
              <li><Link href={`/${lang}/services`} className="hover:text-brand-red transition-colors">{tf.links.services}</Link></li>
              <li><Link href={`/${lang}/contact`} className="hover:text-brand-red transition-colors">{tf.links.contact}</Link></li>
            </ul>
          </div>
